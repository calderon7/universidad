...
var game = (function () {
    ...
    function preloadImages() {
        ...
        deadEvil = new Audio("FX/deadEvil.mp3");
        ...
        playerShotImage.src = 'player/nave/disparo.png';
        evilShotImage = new Image();
        evilShotImage.src = 'images/disparo_malo.png';
        playerKilledImage = new Image();
        playerKilledImage.src = 'player/nave/boom_3.png';
        deadNave = new Audio("FX/deadNave.mp3");
        shootNave = new Audio("FX/disparoNave.mp3");
        gameOver = new Audio("FX/gameOver.mp3");
        songGame = new Audio("FX/playGame.mp3");
        enemigoSound = new Audio("FX/monster.mp3");
        bossSound = new Audio("FX/boss.mp3");
        songBoss = new Audio("FX/songBoss.mp3");
        fine = new Audio("FX/fine.mp3");
        finish = new Audio("FX/finish.mp3");
    }
    ...
    function Player(life, score) {
        ...
        player = new Image();
        player.src = 'player/nave/piloto.png';
